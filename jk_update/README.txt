...
main contains the code I have thus far. 

also, colors and string xml files under (Monster\app\src\main\res\values) are missing cases. my acccachments are a start,
